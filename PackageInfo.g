...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.10.05" ], [ "GradedRingForHomalg", ">= 2011.10.05" ], [ "RingsForHomalg", ">= 2011.10.05" ], [ "Modules", ">= 2011.10.05" ], [ "homalg", ">= 2011.10.05" ], [ "MatricesForHomalg", ">= 2011.10.05" ] ],

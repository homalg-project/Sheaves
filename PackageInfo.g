...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.05.15" ], [ "GradedRingForHomalg", ">= 2011.04.22" ], [ "RingsForHomalg", ">= 2010.02.17" ], [ "Modules", ">= 2011.05.29" ], [ "homalg", ">= 2011.05.15" ], [ "MatricesForHomalg", ">= 2011.05.17" ] ],

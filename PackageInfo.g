...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.06.08" ], [ "GradedRingForHomalg", ">= 2011.04.22" ], [ "RingsForHomalg", ">= 2010.02.17" ], [ "Modules", ">= 2011.06.08" ], [ "homalg", ">= 2011.06.08" ], [ "MatricesForHomalg", ">= 2011.05.17" ] ],

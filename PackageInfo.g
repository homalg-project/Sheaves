...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.06.13" ], [ "GradedRingForHomalg", ">= 2011.04.22" ], [ "RingsForHomalg", ">= 2010.02.17" ], [ "Modules", ">= 2011.06.13" ], [ "homalg", ">= 2011.06.20.17:00" ], [ "MatricesForHomalg", ">= 2011.06.13" ] ],

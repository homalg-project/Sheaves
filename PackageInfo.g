...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.08.30" ], [ "GradedRingForHomalg", ">= 2011.08.14" ], [ "RingsForHomalg", ">= 2010.02.17" ], [ "Modules", ">= 2011.08.30" ], [ "homalg", ">= 2011.08.21" ], [ "MatricesForHomalg", ">= 2011.08.30" ] ],

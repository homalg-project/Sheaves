...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.05.06" ], [ "GradedRingForHomalg", ">= 2011.04.22" ], [ "RingsForHomalg", ">= 2010.02.17" ], [ "Modules", ">= 2011.05.06" ], [ "homalg", ">= 2011.05.06" ], [ "MatricesForHomalg", ">= 2010.10.08" ] ],
